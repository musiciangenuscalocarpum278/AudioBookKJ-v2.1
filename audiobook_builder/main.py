...
def main():
    ...
    for filename in files_to_process:
        ...
        for i in range(start_chunk_idx, len(chunks)):
            ...
            # 1. Gọi Đạo diễn (Chuẩn bị kịch bản)
            script_result = safe_process_script_chunk(chunk)
            script_lines = script_result.get("lines", script_result) if isinstance(script_result, dict) else script_result
